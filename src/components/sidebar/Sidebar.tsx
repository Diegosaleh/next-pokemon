...
import { IoBrowsersOutline, IoCalculator, IoFootball, IoHeartHalfOutline, IoLogoReact } from "react-icons/io5"
  ...
  return (
    <div id="menu" 
        ...
        <div id="logo" className ="my-4 px-6">
            ...
            <p className ="text-stone-400 text-sm">Manejá tus acciones y tus actividades</p>
        </div>
